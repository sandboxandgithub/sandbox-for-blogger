...
function pagination(a) {
    ...
    postnumber > 1 && (e += 2 == postnumber ? "page" == type ? '<a href="' + home_page + '"><span class="showpage">' + prevpage + "</span></a>" : '<a href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '"><span class="pagenumber">' + prevpage + "</span></a>" : "page" == type ? '<a href="#" onclick="redirectpage(' + s + ');return false"><span class="pagenumber">' + prevpage + "</span></a>" : '<a href="#" onclick="redirectlabel(' + s + ');return false"><span class="pagenumber">' + prevpage + "</span></a>"), start > 1 && (e += "page" == type ? '<a href="' + home_page + '"><span class="pagenumber">1</span></a>' : '<a href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '"><span class="pagenumber">1</span></a>'), start > 2 && (e += "");
    for (var r = start; r <= end; r++) e += postnumber == r ? '<span class="current">' + r + "</span>" : 1 == r ? "page" == type ? '<a href="' + home_page + '"><span class="pagenumber">1</span></a>' : '<a href="/search/label/' + lblname1 + "?&max-results=" + postperpage + '"><span class="pagenumber">1</span></a>' : "page" == type ? '<a href="#" onclick="redirectpage(' + r + ');return false"><span class="pagenumber">' + r + "</span></a>" : '<a href="#" onclick="redirectlabel(' + r + ');return false"><span class="pagenumber">' + r + "</span></a>";
    end < maximum - 1 && (e += ""), end < maximum && (e += "page" == type ? '<a href="#" onclick="redirectpage(' + maximum + ');return false"><span class="pagenumber">' + maximum + "</span></a>" : '<a href="#" onclick="redirectlabel(' + maximum + ');return false"><span class="pagenumber">' + maximum + "</span></a>");
    var n = parseInt(postnumber) + 1;
    postnumber < maximum && (e += "page" == type ? '<a href="#" onclick="redirectpage(' + n + ');return false"><span class="pagenumber">' + nextpage + "</span></a>" : '<a href="#" onclick="redirectlabel(' + n + ');return false"><span class="pagenumber">' + nextpage + "</span></a>");
